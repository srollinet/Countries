...
namespace SRoll.Countries
{
    public class Country
    {
        ...
        public Country(string alpha2Code, string alpha3Code, string numericCode, string name)
        {
        ...
        internal Country(string alpha2Code, string alpha3Code, string numericCode)
        {
            Alpha2Code = alpha2Code;
            Alpha3Code = alpha3Code;
            NumericCode = numericCode;
            Name = CountryNames.ResourceManager.GetString(Alpha3Code);
        }
